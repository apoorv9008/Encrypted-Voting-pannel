...
class App:
    ...
    def __init__(self,m):
        ...
        self.v0=IntVar()
        self.button3=Button(frame, text=  "SIGN UP", padx=5,width=5 ,height=1,command=self.newwin,fg="blue",bg="black",bd=7)
        ...
        self.button15 = Button(frame,  text = 'EXIT', padx=5,width=5,height=1, command=self.Quit,fg="red",bg="black",bd=7)
        self.button15.grid(row=8,column=5)
        self.button3=Button(frame, text=  "ABOUT",width=5 ,height=1,command=self.aboutus,fg="yellow",bd=7,bg="black")
    ...
    def close(self):
        ...
        self.con=sqlite3.connect('apoorv')
        ...
        if(q1=="ADMIN"):
            if(s == 'qwe123'):
                ...
                self.label=Label(r3,text="WELCOME ADMIN",font="CalibriLight 15 bold",fg="black")
                ...
                self.label21=Label(r3,text="Name",font="CalibriLight 9 bold",fg="blue")
                self.label21.grid(row=2,column=0)
                self.label22=Label(r3,text="Email ID",font="CalibriLight 9 bold",fg="blue")
                self.label22.grid(row=3,column=0)
                self.label23=Label(r3,text="Paswword",font="CalibriLight 9 bold",fg="blue")
            ...
            if(s == self.ab2 and cv == self.ab1):
                ...
                self.label27=Label(r3,text=self.ab2)
                self.label27.grid(row=4,column=1)
                self.label21=Label(r3,text="Name",font="CalibriLight 11 bold",fg="orange")
                self.label21.grid(row=2,column=0)
                self.label22=Label(r3,text="Email ID",font="CalibriLight 11 bold",fg="orange")
                self.label22.grid(row=3,column=0)
                self.label23=Label(r3,text="Paswword",font="CalibriLight 11 bold",fg="orange")
                self.label23.grid(row=4,column=0)
                
                self.label124=Label(r3,text="Please Give Your VOTE Here",fg="blue",font="-weight bold")
                self.label124.grid(row=5,column=0)
               
                self.button64 = Button(r3, text = 'VOTE IT', padx=20,width=5,height=1, command=self.storevote,fg="red")
    ...
    def newwin(self):
        ...
        self.con=sqlite3.connect('apoorv')
        self.cur = self.con.cursor()
        self.label=Label(frame2,text="Register your information to this page",fg="brown",bg="lightblue",font="CalibriLight 17 bold")
        self.label.grid(row=0,column=1)
        
        self.button7 = Button(frame2,text = 'REGISTER', padx=10,width=10,height=2,fg="yellow",bg="black",font=3,command=self.Error1,bd=7)
        ...
        self.label=Label(frame2,text="First Name",fg="purple",font="CalibriLight 11 bold",bg="lightblue")
        self.label.grid(row=1,column=0)
        self.label=Label(frame2,text="Last Name",fg="purple",font="CalibriLight 11 bold",bg="lightblue")
        self.label.grid(row=1,column=2)
        self.label=Label(frame2,text="Email ID",fg="purple",font="CalibriLight 11 bold",bg="lightblue")
        self.label.grid(row=2,column=0)
        self.label=Label(frame2,text="Password",fg="purple",font="CalibriLight 11 bold",bg="lightblue")
        self.label.grid(row=3,column=0)
    ...
    def aboutus(self):
        ...
        Label(self.master, text='Name:             Apoorv Kumar (141186)',fg='black',font='Times 20 bold').pack(side=TOP,anchor=CENTER)
        ...
        Label(self.master, text='ADMIN ID: Apooorv        PASSWORD:qwe123',fg='black',font='Times 13').pack(side=BOTTOM,anchor=CENTER)
    def storevote(self):
        self.con=sqlite3.connect('apoorv')
        self.cur = self.con.cursor()
        ...
        if(e2 == 1):
            ...
            z0= 'Mr XYZ'
            k2=35
        self.label=Label(r8,text="THANKS FOR VOTING"+" "+z0,font="Times 9 bold",fg="black")
        self.label.grid(row=0,column=1)
